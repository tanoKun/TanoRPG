...
public class BaseVindicator extends ObjectEntity {

    public BaseVindicator(Config config) {
        super(config);
    }

    @Override
    public Entity spawn(Location location) {
        Vindicator entity = (Vindicator) location.getWorld().spawnEntity(location, EntityType.VINDICATOR);
        setOptions(entity);
    ...
    public Entity setOptions(Entity entity) {
        Vindicator target = (Vindicator) entity;
