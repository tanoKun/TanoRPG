...
public enum EntityTypes {
    ...
    BABY_PIG_ZOMBIE_VILLAGER(BaseBabyPigZombieVillager.class),
    ...
    PIG_ZOMBIE_VILLAGER(BasePigZombieVillager.class),
    ...
    EntityTypes(Class<? extends ObjectEntity> clazz) {
        CLASS = clazz;
    }

    public Class<? extends ObjectEntity> getCLASS() {
        return CLASS;
    }
}
