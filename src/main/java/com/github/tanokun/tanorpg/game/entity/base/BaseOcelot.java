...
public class BaseOcelot extends ObjectEntity {

    public BaseOcelot(Config config) {
        super(config);
    }

    @Override
    public Entity spawn(Location location) {
        Ocelot entity = (Ocelot) location.getWorld().spawnEntity(location, EntityType.OCELOT);
        setOptions(entity);
