...
public class BaseWitherSkeleton extends ObjectEntity {
    ...
    public BaseWitherSkeleton(Config entityConfig, String name, StatusMap statusMap, EquipmentMap equipMap, EntityDropItems dropItems, int exp, int level) {
    ...
    public Entity spawn(Location location) {
        ...
        WitherSkeleton entity = new CraftWitherSkeleton((CraftServer) Bukkit.getServer(),
                new EntitySkeletonWither(EntityTypes.WITHER_SKELETON, craftWorld.getHandle().getMinecraftWorld()));
