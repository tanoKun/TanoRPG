...
public class BaseVex extends ObjectEntity {

    public BaseVex(Config config) {
        super(config);
    }

    @Override
    public Entity spawn(Location location) {
        Vex entity = (Vex) location.getWorld().spawnEntity(location, EntityType.VEX);
        setOptions(entity);
