...
public class BaseGuardian extends ObjectEntity {
    ...
    public BaseGuardian(Config entityConfig, String name, StatusMap statusMap, EquipmentMap equipMap, EntityDropItems dropItems, int exp, int level) {
    ...
    public Entity spawn(Location location) {
        ...
        Guardian entity = new CraftGuardian((CraftServer) Bukkit.getServer(),
                new EntityGuardian(EntityTypes.GUARDIAN, craftWorld.getHandle().getMinecraftWorld()));
