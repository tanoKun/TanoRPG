...
public class BaseEvoker extends ObjectEntity {

    public BaseEvoker(Config config) {
        super(config);
    }

    @Override
    public Entity spawn(Location location) {
        Evoker entity = (Evoker) location.getWorld().spawnEntity(location, EntityType.EVOKER);
        setOptions(entity);
