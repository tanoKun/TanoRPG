...
public class BaseGiant extends ObjectEntity {

    public BaseGiant(Config config) {
        super(config);
    }

    @Override
    public Entity spawn(Location location) {
        Giant entity = (Giant) location.getWorld().spawnEntity(location, EntityType.GIANT);
        setOptions(entity);
