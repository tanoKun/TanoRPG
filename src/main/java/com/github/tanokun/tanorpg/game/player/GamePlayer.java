...
public class GamePlayer {
    ...
    public void setMAX_MP(double MAX_MP) {this.MAX_MP = MAX_MP;}
    public void setTHIS_MAX_MP(double THIS_MAX_MP) {this.THIS_MAX_MP = THIS_MAX_MP;}
    public void setHAS_MP (double HAS_MP){this.HAS_MP = HAS_MP;}
    public void setLEVEL ( int LEVEL){this.LEVEL = LEVEL;}
    public void setMAX_EXP (long MAX_EXP){this.MAX_EXP = MAX_EXP;}
    ...
    public void setHAS_EXP (long HAS_EXP){
        ...
        for (int i = 0; this.HAS_EXP >= MAX_EXP; i++) {
            ...
            Bukkit.dispatchCommand(Bukkit.getConsoleSender(),
                    "execute " + getName() + " ~ ~ ~ playsound entity.experience_orb.pickup player @s ~ ~ ~ 10 1");
        }
    }
