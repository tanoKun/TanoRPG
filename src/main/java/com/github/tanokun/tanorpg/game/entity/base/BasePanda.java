...
public class BasePanda extends ObjectEntity {
    public BasePanda(Config config) {
        super(config);
    }

    @Override
    public Entity spawn(Location location) {
        Panda entity = (Panda) location.getWorld().spawnEntity(location, EntityType.PANDA);
        setOptions(entity);
