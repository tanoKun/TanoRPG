...
public class BaseParrot extends ObjectEntity {
    public BaseParrot(Config config) {
        super(config);
    }

    @Override
    public Entity spawn(Location location) {
        Parrot entity = (Parrot) location.getWorld().spawnEntity(location, EntityType.PARROT);
        setOptions(entity);
