...
public class BaseBabyHusk extends ObjectEntity {

    public BaseBabyHusk(Config config) {
        super(config);
    }

    @Override
    public Entity spawn(Location location) {
        Husk entity = (Husk) location.getWorld().spawnEntity(location, EntityType.HUSK);
        entity.setBaby(true);
        setOptions(entity);
