...
public class BaseRavager extends ObjectEntity {

    public BaseRavager(Config config) {
        super(config);
    }

    @Override
    public Entity spawn(Location location) {
        Ravager entity = (Ravager) location.getWorld().spawnEntity(location, EntityType.RAVAGER);
        setOptions(entity);
