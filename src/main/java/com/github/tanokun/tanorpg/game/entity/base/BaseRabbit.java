...
public class BaseRabbit extends ObjectEntity {

    public BaseRabbit(Config config) {
        super(config);
    }

    @Override
    public Entity spawn(Location location) {
        Rabbit entity = (Rabbit) location.getWorld().spawnEntity(location, EntityType.RABBIT);
        setOptions(entity);
